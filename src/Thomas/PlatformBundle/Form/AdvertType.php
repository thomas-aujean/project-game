...
use Thomas\PlatformBundle\Repository\CategoryRepository;
...
class AdvertType extends AbstractType
{
    ...
    //     'allow_delete' => true
    //   ))
    // j'aime bien celui d'en dessous
    // ->add('categories', EntityType::class, array(
    //     'class'        => 'ThomasPlatformBundle:Category',
    //     'choice_label' => 'name',
    //     'multiple'     => true,
    // ))
        ->add('categories', EntityType::class, array(
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Thomas\PlatformBundle\Entity\Advert'
        ));
    }
    ...
    {
        return 'thomas_platformbundle_advert';
    }
